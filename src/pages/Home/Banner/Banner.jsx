    ...
    return (
        <div className='banner w-[100%] h-[450px]'>
            <div className='w-full h-full flex items-center'>
                <div className='w-full md:w-[60%] px-5 md:ps-10 text-white'>
                    ...
                    <button className='text-zinc-700 text-sm font-medium bg-white py-2 px-5 border border-zinc-400 rounded-full hover:text-orange-600 hover:border-orange-600 hover:shadow-lg active:shadow-none ease-in-out duration-300'>View Menu</button>
                </div>
            </div>
        </div>
    );
